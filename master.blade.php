            ...
            <section class="sidebar">
                ...
                <ul class="sidebar-menu">
                    ...
                    <li class="treeview">
                        <a href="#">
                            <i class="fa fa-users"></i>
                            <span>{{ trans('fi.vendors') }}</span>
                            <i class="fa fa-angle-left pull-right"></i>
                        </a>
                        <ul class="treeview-menu">
                            <li><a href="{{ route('vendors.create') }}"><i class="fa fa-angle-double-right"></i> {{ trans('fi.add_vendor') }}</a></li>
                            <li><a href="{{ route('vendors.index') }}"><i class="fa fa-angle-double-right"></i> {{ trans('fi.view_vendors') }}</a></li>
                        </ul>
                    </li>
                    <li class="treeview">
                        <a href="#">
